...
function Nav() {
  ...
  return (
    <div
      className={`${
        scrolled
          ? "bg-black/70 backdrop-blur-md shadow-lg fixed w-full z-50"
          : ""
      }`}
    >
      <div className="">
        ...
        <div className="md:hidden flex justify-between items-center px-5 py-3">
          ...
          <div
            ...
            className="active:scale-90 duration-300 bg-white/40 border-black px-3 py-1 rounded-xl z-40"
          >
        ...
        >
          <div className="flex flex-col gap-5 items-center">
            ...
            <div className="text-white font-bold flex flex-col items-center gap-7">
              ...
              <Link className="hover:text-amber-600" href="/shop">
                Shop
              </Link>
              <Link className="hover:text-amber-600" href="/service">
                Service
              </Link>
